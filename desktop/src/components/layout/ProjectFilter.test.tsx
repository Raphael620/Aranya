...
describe('ProjectFilter', () => {
  beforeEach(() => {
    ...
    useSessionStore.setState({
      ...
      availableProjects: [
        ...
        'Users-nanmi-workspace-myself_code-aranya',
      ],
    })
  })
  ...
  it('renders recent project metadata instead of bare fallback folder names', async () => {
    getRecentProjectsMock.mockResolvedValue({
      projects: [
        {
          projectPath: 'Users-nanmi-workspace-myself_code-aranya',
          realPath: '/Users/nanmi/workspace/myself_code/aranya',
          projectName: 'aranya',
          isGit: true,
    ...
    await waitFor(() => {
      ...
      expect(screen.getByText('/Users/nanmi/workspace/myself_code/aranya')).toBeInTheDocument()
    ...
    await waitFor(() => {
      expect(useSessionStore.getState().selectedProjects).toEqual(['Users-nanmi-workspace-myself_code-aranya'])
    })
