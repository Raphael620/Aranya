...
APP_BUNDLE_NAME="Aranya.app"
APP_BUNDLE_ID="com.aranya.desktop"

usage() {
  cat <<'EOF'
Build Aranya desktop for macOS Apple Silicon and output a DMG.
...
if [[ -n "${LATEST_APP}" ]]; then
  ...
  # Without this, opening target/.../bundle/macos/Aranya.app directly
  ...
  CANONICAL_DMG="${CANONICAL_OUTPUT_DIR}/$(basename "${LATEST_DMG:-Aranya_0.1.0_aarch64.dmg}")"
  build_canonical_dmg \
